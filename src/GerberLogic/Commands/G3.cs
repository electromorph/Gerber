...
namespace GerberLogic.Commands
{
    ...
    /// Draw a circle
    /// </summary>
    public class G3 : iCommand
    {
        Dictionary<string, float> _commandArgs;
        Globals _globals;
        GerberImage _image;

        public G3(Dictionary<string, float> CommandArgs, Globals Globals, GerberImage Image)
        {
        ...
        public void Process()
        {
            ...
            {
                cmp = new Circle(_globals.LastPoint, endPoint, centrePoint, _globals.CirclesAreSingleQuadrant, false, _globals.LastStandardAperture, _globals.PolygonAreaFill);
            }
